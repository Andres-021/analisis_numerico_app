        ...
        <Row className='mb-3'>
          <Col lg className="mb-3">
            ...
            {/* <Form.Label>Porcentaje</Form.Label> */}
              <Form.Control type="number" placeholder="Porcentaje" value={props.input} onChange={props.onChangeInput} min={0}/>
            </FormGroup>
          </Col>
          ...
          <Col lg className="mb-3">
            ...
            {/* <Form.Label>Intervalo Superior</Form.Label> */}
              <Form.Control type="number" placeholder="Superior" value={props.iSuperior} onChange={props.onChangeISuperior}/>
            </FormGroup>
          </Col>
          <Col lg className="mb-3">
            <FormGroup>
              {/* <Form.Label>Intervalo Inferior</Form.Label> */}
              <Form.Control type="number" placeholder="Inferior" value={props.iInferior} onChange={props.onChangeIInferior}/>
            </FormGroup>
          </Col>
