...
const IndexBiseccion = () => {
  ...
  const submitDatos = (e) => {
    ...
    setEntrada({input:input, fun:fun, iSuperior:iSuperior, iInferior:iInferior});
        ...
        <Col lg className="d-grid mb-3">
          <Collapse in={view}>
            <div id="example-collapse">
              <Alert variant="primary">
                <div style={{color: ''}}>
                  <strong><h4>Datos usados</h4></strong>
                  <p>
                    %: <Badge><strong>{entrada.input}</strong></Badge>&nbsp;
                    Funcion: <Badge><strong>{entrada.fun}</strong></Badge>&nbsp;
                    x0: <Badge><strong>{entrada.iSuperior}</strong></Badge>&nbsp;
                    xi: <Badge><strong>{entrada.iInferior}</strong></Badge>
                  </p>
                </div>
              </Alert>
            </div>
          ...
          <Collapse in={view}>
            <div id="example-collapse">
              <Alert variant="primary">
                <div style={{color: ''}}>
                  <strong><h4>Solucion final</h4></strong>
                  
                  <p>
                    Iteraciones totales: <Badge><strong>{solucion.i}</strong></Badge>&nbsp; 
                    La raiz es, xr: <Badge><strong>{solucion.xr_actual}</strong></Badge>&nbsp;
